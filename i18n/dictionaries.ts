...
export const dictionaries = {
  en: {
    ...
    reservation: {
      ...
      description: 'Airport, hotel, or any destination in Marrakech. Send your trip details and receive a quick confirmation.',
      from: 'Pick-up location',
      to: 'Drop-off location',
      date: 'Date',
      time: 'Pick-up time',
      fromPlaceholder: 'Airport, hotel, or address',
      toPlaceholder: 'Hotel, airport, or place in Marrakech',
      submit: 'Request this transfer',
      note: 'No payment required — we will confirm availability and price on WhatsApp.',
      messageTitle: 'New private transfer request',
    },
    whyChooseUs: {
      badge: 'Why Choose Us',
    ...
    contact: {
      ...
      info: [
        ...
        { label: 'Email', value: 'qostassiyoussef17@gmail.com' },
      ],
    },
    footer: {
  ...
  fr: {
    ...
    reservation: {
      eyebrow: 'Transfert prive',
      title: 'Ou souhaitez-vous aller ?',
      description: 'Aeroport, hotel ou toute destination a Marrakech. Envoyez les details de votre trajet pour recevoir une confirmation rapide.',
      from: 'Lieu de prise en charge',
      to: 'Destination',
      date: 'Date',
      time: 'Heure de prise en charge',
      fromPlaceholder: 'Aeroport, hotel ou adresse',
      toPlaceholder: 'Hotel, aeroport ou lieu a Marrakech',
      submit: 'Demander ce transfert',
      note: 'Aucun paiement requis — nous confirmerons la disponibilite et le prix sur WhatsApp.',
      messageTitle: 'Nouvelle demande de transfert prive',
    },
    whyChooseUs: {
